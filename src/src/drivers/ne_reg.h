 ...
 */
#define NE_CR_PS0	0x40
#define NE_CR_PS1	0x80
/* bit encoded aliases */
#define NE_CR_PAGE_0	0x00 /* (for consistency) */
#define NE_CR_PAGE_1	(NE_CR_PS0)
#define NE_CR_PAGE_2	(NE_CR_PS1)
#define	NE_CR_PAGE_3	(NE_CR_PS1|NE_CR_PS0)
...
#define NE_RING_RSR		0	/* receiver status */
#define NE_RING_NEXT_PACKET	1	/* pointer to next packet */
#define NE_RING_COUNT		2	/* bytes in packet (length + 4) */
#define NE_RING_HDRSZ		4	/* Header size */

/*
 * Common constants
 */
#define NE_PAGE_SIZE		256	/* Size of RAM pages in bytes */
#define	NE_PAGE_MASK		255
#define	NE_PAGE_SHIFT		8
